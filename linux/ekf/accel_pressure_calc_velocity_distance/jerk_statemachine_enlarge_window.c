...
// 增大窗口大小 JERK_WINDOW 以更稳定地检测状态变化。
// 
// 移除 CONFIRMATION_COUNT 机制，改为直接依据窗口数据判定状态。
// 你可以调整 JERK_WINDOW 以优化平滑度和实时性之间的平衡。
//
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
#define ACCELERATION_THRESHOLD 0.3 // 加速度变化最小阈值
#define JERK_THRESHOLD 0.001     // 抖动方差阈值
#define JERK_WINDOW 5          // 抖动判断窗口大小，增加窗口大小
