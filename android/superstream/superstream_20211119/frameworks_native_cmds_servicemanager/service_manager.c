...
#else
static bool check_mac_perms(__unused pid_t spid, __unused uid_t uid, __unused const char *tctx, __unused const char *perm, __unused const char *name)
{
...
#else
// mxp, 20211112, do not verify it ...
static bool check_mac_perms_from_lookup(__unused pid_t spid, __unused uid_t uid, __unused const char *perm, __unused const char *name)
{
    return true;
}
#endif
